...
//
//class DbAdapter: RecyclerView.Adapter<DbAdapter.MatchVH>() {
//
//    private lateinit var matchList:List<DbModel?>
//
...
//    fun updateData(list: List<DbModel?>?){
//        this.matchList = list!!
...
//        fun bindItem(list: DbModel?) = with(binding.root){
